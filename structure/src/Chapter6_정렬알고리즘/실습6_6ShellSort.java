...
public class 실습6_6ShellSort {
 //--- 셸 정렬 ---//
 static void shellSort(int[] a, int n) {
	 int count = 0;
     for (int h = n / 2; h > 0; h /= 2)//n = 8 등 짝수일 때 4,2 등으로 효과가 적다,	n번 반복
         for (int i = h; i < n; i++) {//h=2이면 i=2,3,4,5,6 등으로 반복,	n - k번 반복
